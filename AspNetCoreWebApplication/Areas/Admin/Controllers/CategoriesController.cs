...
namespace AspNetCoreWebApplication.Areas.Admin.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        {
            var kayit = _context.Categories.FirstOrDefault(c => c.Id == id); //FirstOrDefault entity framework ün kayıt bulma metodlarından biridir.
        ...
        {
            var kayit = await _context.Categories.FirstOrDefaultAsync(c => c.Id == id); //FirstOrDefault entity framework ün kayıt bulma metodlarından biridir.
            if (kayit == null) return NotFound();
            return View(kayit);
